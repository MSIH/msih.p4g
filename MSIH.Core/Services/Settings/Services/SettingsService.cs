...
namespace MSIH.Core.Services.Settings.Services
{
    /// <summary>
    ...
    public class SettingsService : ISettingsService
    {
        ...
        public async Task<string?> GetValueAsync(string key)
        {
            ...
            await _settingsRepository.AddAsync(new Models.Setting { Key = key, Value = resolvedValue });
        ...
        public async Task SetValueAsync(string key, string? value, string modifiedBy = "SettingsService")
        {
            ...
            if (setting == null)
            {
                await _settingsRepository.AddAsync(new Models.Setting { Key = key, Value = value }, modifiedBy);
            }
            else
            {
                setting.Value = value;
