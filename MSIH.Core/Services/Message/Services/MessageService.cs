...
using MSIH.Core.Services.Message.Utilities;
...
using MessageTemplateUsage = MSIH.Core.Services.Message.Models.MessageTemplateUsage;

namespace MSIH.Core.Services.Message.Services
{
    /// <summary>
