...
namespace MSIH.Core.Services.Message.Interfaces
{
    ...
    /// </summary>
    public interface IMessageRepository : IGenericRepository<MSIH.Core.Services.Message.Models.Message>
    {
        /// <summary>
        ...
        Task<IEnumerable<MSIH.Core.Services.Message.Models.Message>> GetPendingMessagesAsync(int limit = 50, int maxRetries = 3);
        ...
        Task<IEnumerable<MSIH.Core.Services.Message.Models.Message>> GetScheduledMessagesAsync(DateTime before, int limit = 50, int maxRetries = 3);
        ...
        Task<IEnumerable<MSIH.Core.Services.Message.Models.Message>> GetFailedMessagesAsync(int limit = 50, int maxRetries = 3);
        ...
        Task<IEnumerable<MSIH.Core.Services.Message.Models.Message>> GetMessagesByTypeAsync(string messageType, int limit = 50);
        ...
        Task<IEnumerable<MSIH.Core.Services.Message.Models.Message>> GetMessagesByRecipientAsync(string recipient, int limit = 50);
        ...
        Task<MSIH.Core.Services.Message.Models.Message> UpdateMessageStatusAsync(int id, bool isSuccess, string errorMessage = "");
