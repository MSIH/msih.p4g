...
namespace MSIH.Core.Services.Profiles.Model
{
    /// <summary>
    ...
    public class Profile : BaseEntity
    {
        ...
        public virtual MSIH.Core.Services.Users.Models.User User { get; set; }
        ...
        public bool ConsentReceiveEmail { get; set; } = true; // to use the service, user must consent to receive emails
