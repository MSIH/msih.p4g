...
namespace MSIH.Core.Common.Data
{
    ...
    public partial class ApplicationDbContext
    {
        ...
        partial void ConfigureMessageModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MSIH.Core.Services.Messages.Models.Message>(entity =>
            {
            ...
            modelBuilder.Entity<MSIH.Core.Services.Messages.Models.MessageTemplate>(entity =>
            {
                entity.HasKey(e => e.Id);
            ...
            modelBuilder.Entity<MSIH.Core.Services.Messages.Models.MessageTemplateUsage>(entity =>
            {
                entity.HasKey(e => e.MessageId);

                entity.HasOne(e => e.Message)
                    .WithOne()
                    .HasForeignKey<MSIH.Core.Services.Messages.Models.MessageTemplateUsage>(e => e.MessageId)
