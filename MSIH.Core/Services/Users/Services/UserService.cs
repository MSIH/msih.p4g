...
namespace MSIH.Core.Services.Users.Services
{
    /// <summary>
    ...
    public class UserService : IUserService
    {
        ...
        /// <inheritdoc />
        public async Task<UserEntity> AddAsync(UserEntity user, string createdBy = "UserService")
        {
        ...
        /// <inheritdoc />
        public async Task UpdateAsync(UserEntity user, string modifiedBy = "UserService")
        {
        ...
        public async Task<UserEntity?> GetUserByTokenAsync(string emailToken)
        {
