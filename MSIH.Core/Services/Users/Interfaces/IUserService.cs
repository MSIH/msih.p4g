...
namespace MSIH.Core.Services.Users.Interfaces
{
    ...
    public interface IUserService
    {
        ...
        Task<UserEntity?> GetByReferralCodeAsync(string referralCode, bool includeProfile = false, bool includeAddress = false, bool includeDonor = false, bool includeFundraiser = false);

        Task<UserEntity> AddAsync(UserEntity user, string createdBy = "UserService");
        ...
        Task UpdateAsync(UserEntity user, string modifiedBy = "UserService");
