...
namespace Tests.Server.Tests.Features.Base.UserProfileService
{
    ...
    public class UserProfileServiceTests
    {
        ...
        private msih.p4g.Server.Features.Base.UserProfileService.Services.UserProfileService _userProfileService;
        ...
        public void Setup()
        {
            ...
            _userProfileService = new msih.p4g.Server.Features.Base.UserProfileService.Services.UserProfileService(_mockUserService.Object, _mockProfileService.Object);
        }
