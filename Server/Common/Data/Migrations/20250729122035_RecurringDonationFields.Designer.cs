...
namespace msih.p4g.Server.Common.Data.Migrations
{
    ...
    [Migration("20250729122035_RecurringDonationFields")]
    partial class RecurringDonationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("msih.p4g.Server.Features.Base.PayoutService.Models.Payout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("msih.p4g.Server.Features.Base.W9FormService.Models.W9Form", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("msih.p4g.Server.Features.DonationService.Models.Donation", b =>
                {
                    ...
                    b.Property<int?>("ParentRecurringDonationId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RecurringPaymentToken")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.HasIndex("ParentRecurringDonationId");
            ...
            modelBuilder.Entity("msih.p4g.Server.Features.DonationService.Models.Donation", b =>
                {
                    ...
                    b.HasOne("msih.p4g.Server.Features.DonationService.Models.Donation", "ParentRecurringDonation")
                        .WithMany("RecurringPayments")
                        .HasForeignKey("ParentRecurringDonationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ParentRecurringDonation");
