...
namespace msih.p4g.Server.Features.Base.MessageService.Interfaces
{
    ...
    public interface IMessageService
    {
        ...
        /// <param name="from">Sender email address (optional, uses default if not specified)</param>
        /// <returns>The created message entity</returns>
        Task<Message> ScheduleEmailAsync(string to, string subject, string htmlContent, DateTime scheduledFor, string from = null);
        ...
        /// <param name="from">Sender phone number (optional, uses default if not specified)</param>
        /// <returns>The created message entity</returns>
        Task<Message> ScheduleSmsAsync(string to, string content, DateTime scheduledFor, string from = null);
        ...
        Task<IEnumerable<Message>> GetMessageHistoryAsync(string recipient, int limit = 50);
        ...
        Task<IEnumerable<Message>> GetRecentEmailsAsync(int limit = 50);
        ...
        Task<IEnumerable<Message>> GetRecentSmsAsync(int limit = 50);
