...
using msih.p4g.Server.Features.Base.W9FormService.Utilities;
using msih.p4g.Shared.W9FormService.Dtos;
using System.Security.Claims;

namespace msih.p4g.Server.Features.Base.W9FormService.Services
{
    /// <summary>
    ...
    public class W9FormService : IW9FormService
    {
        ...
        private async Task<bool> UserHasAccessToFormAsync(W9Form form)
        {
        ...
        private W9FormDto MapToDto(W9Form entity)
        {
