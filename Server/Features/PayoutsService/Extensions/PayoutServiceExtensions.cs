...
using msih.p4g.Server.Features.PayoutService.Repositories;
using msih.p4g.Server.Features.PayoutService.Services;

namespace msih.p4g.Server.Features.PayoutService.Extensions
{
    /// <summary>
