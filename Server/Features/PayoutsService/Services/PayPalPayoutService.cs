...
using msih.p4g.Server.Features.PayoutService.Models.Configuration;
...
namespace msih.p4g.Server.Features.PayoutService.Services
{
    /// <summary>
    ...
    public class PayPalPayoutService : IPayoutService
    {
        ...
        /// </summary>
        public async Task<PayoutEntity> CreatePayoutAsync(
            string fundraiserId,
            string paypalEmail,
            decimal amount,
            string currency = "USD",
        ...
        /// </summary>
        public async Task<List<PayoutEntity>> ProcessBatchPayoutsAsync(List<string> payoutIds)
        {
        ...
        /// Get a Payout by ID
        /// </summary>
        public async Task<PayoutEntity> GetPayoutAsync(string payoutId)
        {
        ...
        /// </summary>
        public async Task<List<PayoutEntity>> GetFundraiserPayoutHistoryAsync(string fundraiserId, int page = 1, int pageSize = 20)
        {
        ...
        /// </summary>
        public async Task<List<PayoutEntity>> GetPayoutsByStatusAsync(PayPalTransactionStatusEnum status, int page = 1, int pageSize = 20)
        {
        ...
        /// </summary>
        public async Task<List<PayoutEntity>> GetPayoutsByFundraiserIdAsync(string fundraiserId)
        {
        ...
        public async Task<List<PayoutEntity>> UpdateBatchPayoutStatusAsync(string batchId)
        {
            if (string.IsNullOrEmpty(batchId))
                throw new ArgumentException("Batch ID is required", nameof(batchId));
        ...
        /// </summary>
        private async Task<PayPalPayoutResponse> CreatePayPalPayoutAsync(PayoutEntity payout)
        {
        ...
        /// </summary>
        private async Task<PayPalPayoutResponse> CreatePayPalBatchPayoutAsync(List<PayoutEntity> payouts)
        {
        ...
        private object CreatePayoutItem(Payout payout)
        {
            ...
            {
                case AccountFormat.Mobile:
                    item["recipient_type"] = "PHONE";
                    break;
                case AccountFormat.Email:
                    item["recipient_type"] = "EMAIL";
                    break;
                case AccountFormat.Handle:
