...
namespace msih.p4g.Server.Features.OrganizationService.Interfaces
{
    ...
    public interface IOrganizationService
    {
        ...
        Task<Organization> AddAsync(Organization organization, string createdBy = "System");
        ...
        Task<Organization> UpdateAsync(Organization organization, string modifiedBy = "System");
