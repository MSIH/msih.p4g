...
namespace msih.p4g.Server.Features.OrganizationService.Data.Migrations
{
    ...
    [Migration("20250621122152_AddOrganizationtoCampaign")]
    partial class AddOrganizationtoCampaign
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("msih.p4g.Server.Features.CampaignService.Model.Campaign", b =>
                {
                    ...
                    b.HasOne("msih.p4g.Server.Features.OrganizationService.Models.Organization", "Organization")
                        .WithMany()
