...
namespace msih.p4g.Server.Features.OrganizationService.Services
{
    ...
    public class OrganizationService : IOrganizationService
    {
        ...
        /// <inheritdoc />
        public async Task<Organization> AddAsync(Organization organization, string createdBy = "System")
        {
        ...
        /// <inheritdoc />
        public async Task<Organization> UpdateAsync(Organization organization, string modifiedBy = "System")
        {
            if (organization == null)
            {
                throw new ArgumentNullException(nameof(organization));
        ...
        /// <inheritdoc />
        public async Task<bool> SetActiveStatusAsync(int id, bool isActive, string modifiedBy = "System")
        {
